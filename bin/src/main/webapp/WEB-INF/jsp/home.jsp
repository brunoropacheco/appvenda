...
<body>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	  <div class="container-fluid">
	    <ul class="navbar-nav">
	      ...
	      <li class="nav-item">
	        <a class="nav-link" href="/vestuario/lista">Vestuario</a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link" href="/mecanico/lista">Mecanico</a>
	      </li>
	    </ul>
	  </div>
	</nav>
	...
	<div class="container mt-3">
		...
		<span class="badge rounded-pill bg-primary">Vendedor : ${qtdeVendedor}</span>
	  	...
	  	<span class="badge rounded-pill bg-success">Vestuario: ${qtdeVestuario}</span>
	  	<span class="badge rounded-pill bg-danger">Mecanico: ${qtdeMecanico}</span>
